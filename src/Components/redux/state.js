const CREATE_NEW_PLAYLIST = "CREATE-NEW-PLAYLIST"
const UPDATE_NEW_LIBRARY = "UPDATE-NEW-LIBRARY"
...
let store = {
  ...
  dispatch(action) {//{type:'CREATE-NEW-PLAYLIST'}
    ...
    if (action.type === CREATE_NEW_PLAYLIST) {
      ...
      this._state.libraryPage.LibraryData.push(newPlaylist);
      console.log(this._state.LibraryData);
      this._rerender(this._state);
    } else if (action.type === UPDATE_NEW_LIBRARY) {
      this._state.libraryPage.newLibraryName = action.newList;
      this._rerender(this._state)
    }
  }
...
export const createNewPlaylistActionCreator = (newList) => {
  return {
    type: CREATE_NEW_PLAYLIST,
    newList,
  };
};
export const updateNewLibraryActionCreator = (newList) => {
  return {
    type: UPDATE_NEW_LIBRARY,
    newList,
  };
};
